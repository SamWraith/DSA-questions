...
public:
    bool canSortArray(vector<int>& nums) {
        // Divide the array into distinct segments where each segment is
        // comprised of consecutive elements sharing an equal number of set
        // bits. Ensure that for each segment, when moving from left to right,
        // the maximum of a preceding segment is less than the minimum of the
        // following segment.
        int prevSetBits = 0;
